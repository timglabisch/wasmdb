 ...
 */
export type RunRecurringOnce = { recurring_id: bigint, new_invoice_id: bigint, position_ids: Array<bigint>, new_number: string, issue_date: string, due_date: string, new_next_run: string, };
