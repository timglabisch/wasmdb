...
const rowToInvoice = (r: any[]): InvoiceRow => ({
  ...
  doc_type: r[5] as string, parent_id: r[6] as string, service_date: r[7] as string,
  cash_allowance_pct: r[8] as number, cash_allowance_days: r[9] as number, discount_pct: r[10] as number,
  payment_method: r[11] as string, sepa_mandate_id: r[12] as string,
