...
import type { InvoiceWithoutPk } from 'invoice-demo-generated/tables/Invoice';
...
const rowToInvoice = (r: any[]): InvoiceWithoutPk => ({
  ...
  payment_method: r[11] as string, sepa_mandate_id: (r[12] as string | null) ?? null,
  ...
  customer_id: (r[25] as string | null) ?? null,
});
